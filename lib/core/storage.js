...
export default class Storage {
  ...
  setUniversal (key, value, isJson) {
    ...
    // Storage
    this.setStorage(key, value, isJson)
  ...
  getUniversal (key, isJson) {
    ...
    // Storage
    if (isUnset(value)) {
      value = this.getStorage(key, isJson)
    }
  ...
  setStorage (key, value, isJson) {
    if (this.options.sessionStorage) {
      this.setSessionStorage(key, value, isJson)
    }
  ...
  getStorage (key, isJson) {
    let value = null

    if (this.options.sessionStorage) {
      value = this.getSessionStorage(key, value, isJson)
    }

    if (value === null && this.options.localStorage) {
      value = this.getLocalStorage(key, value, isJson)
    }
