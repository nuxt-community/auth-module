...
export default class Auth {
  ...
  getScope () {
    let userScopes = this.$state.user && getProp(this.$state.user, this.options.scopeKey)

    if (!userScopes && this.strategy.getScope) {
      userScopes = this.strategy.getScope()
    }
  ...
  hasScope (scope) {
    const userScopes = this.getScope()
