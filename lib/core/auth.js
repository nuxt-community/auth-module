...
export default class Auth {
  ...
  setTokenExpiration () {
    ...
    return this.strategy.tokenStatus.setTokenExpiration(...arguments)
  }
  ...
  setRefreshTokenExpiration () {
    ...
    return this.strategy.tokenStatus.setRefreshTokenExpiration(...arguments)
  }

  refreshToken () {
    if (!this.strategy.refreshController.handleRefresh()) {
      return Promise.resolve()
    }
