...
export default class Auth {
  constructor (ctx, options) {
    ...
    this._refreshToken = new RefreshToken(this)
  }
  ...
  setToken (token) {
    return this._token.set(token)
  }

  syncToken () {
    return this._token.sync()
  }

  resetToken () {
    return this._token.reset()
  }
  ...
  getRefreshToken () {
    return this._refreshToken.get()
  }

  setRefreshToken (refreshToken) {
    return this._refreshToken.set(refreshToken)
  }

  syncRefreshToken () {
    return this._refreshToken.sync()
  }

  resetRefreshToken () {
    return this._refreshToken.reset()
  }

  getRefreshTokenStatus () {
    return this._refreshToken.getStatus()
  }
