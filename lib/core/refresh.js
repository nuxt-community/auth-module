...
export class RefreshController {
  ...
  initializeScheduledRefresh () {
    ...
    let intervalDuration = (this.scheme.tokenStatus.getTokenExpiration() - Date.now()) * 0.75
...
export class TokenExpirationStatus {
  ...
  updateRefreshTokenExpiration () {
    ...
    const _tokenTTL = this.scheme.options.refreshToken.maxAge * 1000
    const _tokenExpiresAt = _tokenIssuedAt + _tokenTTL
