...
export default class Auth {
  ...
  get state () {
    if (!this._state_warn_shown) {
      ...
      console.warn('[AUTH] $auth.state is deprecated. Please use $auth.$state or top level props like $auth.isLoggedIn')
    }
  ...
  getState (key) {
    if (!this._get_state_warn_shown) {
      ...
      // eslint-disable-next-line no-console
      console.warn('[AUTH] $auth.getState is deprecated. Please use $auth.$storage.getState() or top level props like $auth.isLoggedIn')
    }
