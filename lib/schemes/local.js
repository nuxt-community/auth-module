...
export default class LocalScheme {
  constructor (auth, options) {
    ...
    this.options.token = this.options.endpoints.login.propertyName || this.options.token
    this.options.user = this.options.endpoints.user.propertyName || this.options.user
  }
  ...
  async login (endpoint) {
    ...
    // Update Token
    if (this.options.tokenRequired) {
      let token = getProp(loginResult, this.options.token)
