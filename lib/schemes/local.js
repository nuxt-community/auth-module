...
export default class LocalScheme {
  ...
  async _tokenRefresh (self) {
    ...
    if (payloadProperties.clientId !== false) {
      endpoint.data[payloadProperties.clientId] = this.options.clientId
    }
  ...
  async mounted () {
    ...
    this.$auth.setClientId(this.options.clientId)
  ...
  async logout (endpoint) {
    ...
    if (this.options.endpoints.logout) {
      ...
      if (payloadProperties.clientId !== false) {
        endpoint.data[payloadProperties.clientId] = this.options.client_id
      }
