    ...
    if (this.options.responseType === 'code' && parsedQuery.code) {
      const { data } = await this.$auth.request({
        ...
        data: encodeQuery({
          ...
          code_verifier: (this.options.code_challenge_method && this.options.code_challenge_method !== DEFAULTS.challenge ? localStorage.getItem('pkce_code_verifier') : undefined)
        })
      });
