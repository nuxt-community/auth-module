import { encodeQuery, parseQuery, normalizePath, urlJoin } from '../utilities'
...
export default class Oauth2Scheme {
  ...
  async login ({ params, state, nonce } = {}) {
    if (this.options.grantType === 'password') {
      return this._passwordLogin(params)
    }
