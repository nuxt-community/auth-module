...
export interface Scheme<OptionsT extends SchemeOptions> extends _Scheme<OptionsT> {
  options: OptionsT
  ...
  setUserToken?(token: string, refreshToken?: string): Promise<HTTPResponse | void>
