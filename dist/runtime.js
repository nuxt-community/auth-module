...
class RefreshToken {
  ...
  _updateExpiration(refreshToken) {
    ...
    try {
      refreshTokenExpiration = _tokenExpiresAtMillis || jwtDecode__default["default"](refreshToken + "").exp * 1e3;
    } catch (error) {
...
class Token {
  ...
  _updateExpiration(token) {
    ...
    const _tokenExpiresAtMillis = _tokenTTLMillis ? _tokenIssuedAtMillis + _tokenTTLMillis : 0;
    try {
      tokenExpiration = _tokenExpiresAtMillis || jwtDecode__default["default"](token + "").exp * 1e3;
    } catch (error) {
